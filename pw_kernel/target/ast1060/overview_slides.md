...
# Build for ARM Cortex-M4 (QEMU)
bazelisk test //pw_kernel/target/ast1030/... --config=k_qemu_ast1030 -- -//pw_kernel/target/ast1030/ipc/user:ipc_test
...
Runs directly in kernel space for testing core primitives without syscall overhead
...
bazelisk test --config=k_qemu_ast1030 //pw_kernel/target/ast1030/threads/kernel:threads_test --test_output=streamed --cache_test_results=no
```
